...
namespace QuanLyChiTieu.Controllers
{
    public class AccountController : Controller
    {
        ...
        private void GuiEmailOTP(string emailNhan, string maOTP)
        {
            ...
            string myEmail = _config["EmailSettings:SenderEmail"];
            string myPass = _config["EmailSettings:SenderPassword"];
            string myName = _config["EmailSettings:SenderName"];

            var fromAddress = new MailAddress(myEmail, myName);
